...
3.  Leave the project name as recommended, select the Resource group
...
5.  When your project is created, you'll land in the **Agents
    Playground**.
...
7.  Scroll down and select **Try in playground**.
